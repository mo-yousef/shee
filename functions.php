...
function shecy_scripts() {
	wp_enqueue_style( 'shecy-style', get_stylesheet_uri(), array(), SHECY_VERSION );
	// wp_enqueue_script( 'shecy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), SHECY_VERSION, true );
}
