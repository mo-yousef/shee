			...
			<form id="edit-product-form" method="post" enctype="multipart/form-data">
				...
				<div class="space-y-6">
					...
					<div>
						...
						<label for="product_images" class="block text-sm font-medium text-gray-700 mt-4">Upload New Images</label>
						...
						<p class="mt-1 text-xs text-gray-500">Only upload new images if you want to replace the current one.</p>
					</div>
				</div>
